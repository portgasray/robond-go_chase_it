...
{
    ROS_INFO("DriveToTargetRquest received - linear_x:%1.2f, angular_z:%1.2f", (float)req.linear_x, (float)req.angular_z);
...
int main(int argc, char** argv)
{
    ...
    ROS_INFO("Ready to send linear x and angular velocities commands");
